...
class EditMenuAdminWidget extends StatefulWidget {
  const EditMenuAdminWidget({Key? key}) : super(key: key);

  @override
  State<EditMenuAdminWidget> createState() => _EditMenuAdminWidgetState();
}

class _EditMenuAdminWidgetState extends State<EditMenuAdminWidget> {
  ...
  late String _selectedMember = members.first;
